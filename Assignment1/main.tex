...
\end{align}
The period of $|\cos(\omega)|$ is $\pi$. The period of $5+4\cos(\omega)$ is $2\pi$. Hence $\abs{H\brak{e^{\j\omega}}}$ is periodic with period $\pi$.( The LCM of $|\cos(\omega)|$ and $5+4\cos(\omega)$ is $\pi$)
